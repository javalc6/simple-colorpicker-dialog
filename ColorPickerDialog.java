                        ...
                        switch (mMode) {
                            case CIRCLE_CIRCLE:
                                ...
                                if (mColors[index] == mCurrentColor)
                                    canvas.drawCircle(x + radius, y + radius, radius, mPaint);
                                else canvas.drawCircle(x + radius, y + radius, radius  - mMarginSize, mPaint);
                                break;
                            case SQUARE_SQUARE:
                            default://same as mode == SQUARE_SQUARE
                                if (mColors[index] == mCurrentColor)
                                    canvas.drawRect(x, y, x + gridL, y + gridL, mPaint);
                                else canvas.drawRect(x + mMarginSize, y + mMarginSize,
